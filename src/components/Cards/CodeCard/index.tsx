...
function CodeCard({className = ""}: ICodeCardProps) {
  return (
    <div className={`${styles.codeContainer} ${className}`}>
      ...
      <pre>
        <span className={styles.order}>3</span>     this.name = <span className={styles.attribute}>&#34;Ian Vinícius&#34;</span>;
      </pre>
      <pre>
        <span className={styles.order}>4</span>     this.stacks = &#91;
      </pre>
      <pre>
        <span className={styles.order}>5</span>         <span className={styles.attribute}>&#34;UI/UX&#34;</span>,
      </pre>
      <pre>
      ...
      <pre>
        <span className={styles.order}>9</span>       this.age = <span className={styles.attribute}>{getAgeByDate('2002/06/02')}</span>;
      </pre>
      <pre>
